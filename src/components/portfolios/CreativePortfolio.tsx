...
const COLOR_THEMES = [
  {
    ...
    expTheme: {
      line: "bg-orange-500",
      nodeGradient: "from-orange-500 to-pink-500",
      card: "bg-white/90 backdrop-blur-sm border-0 shadow-xl rounded-3xl hover:shadow-2xl transition-all",
      position: "text-gray-900",
      company: "text-orange-600 font-semibold",
      badge: "bg-gradient-to-r from-orange-500 to-pink-500 text-white border-0",
      description: "text-gray-700 leading-relaxed",
      layout: "alternating" as const,
    },
    projTheme: {
      card: "bg-white border-0 shadow-xl rounded-3xl overflow-hidden hover:shadow-2xl transition-all",
      imageBg: "bg-gray-100",
      title: "text-xl font-bold text-gray-900",
      titleHover: "text-purple-600",
      description: "text-gray-600 leading-relaxed mb-4",
      badge: "bg-gradient-to-r from-orange-500 to-pink-500 text-white border-0 text-xs",
      cols: "grid grid-cols-1 md:grid-cols-3 gap-8",
    },
  },
  {
    name: "Ocean",
    ...
    projTheme: {
      ...
      description: "text-gray-600 leading-relaxed mb-4",
      badge: "bg-gradient-to-r from-blue-500 to-cyan-500 text-white border-0 text-xs",
      cols: "grid grid-cols-1 md:grid-cols-3 gap-8",
    },
  },
  {
    ...
    expTheme: {
      line: "bg-green-500",
      nodeGradient: "from-green-500 to-emerald-500",
      card: "bg-white/90 backdrop-blur-sm border-0 shadow-xl rounded-3xl hover:shadow-2xl transition-all",
      position: "text-gray-900",
      company: "text-green-600 font-semibold",
    ...
    projTheme: {
      ...
      description: "text-gray-600 leading-relaxed mb-4",
      badge: "bg-gradient-to-r from-green-500 to-emerald-500 text-white border-0 text-xs",
      cols: "grid grid-cols-1 md:grid-cols-3 gap-8",
    },
  },
  {
    ...
    expTheme: {
      line: "bg-purple-500",
      nodeGradient: "from-purple-500 to-pink-500",
      card: "bg-white/90 backdrop-blur-sm border-0 shadow-xl rounded-3xl hover:shadow-2xl transition-all",
      position: "text-gray-900",
      company: "text-purple-600 font-semibold",
      badge: "bg-gradient-to-r from-purple-500 to-pink-500 text-white border-0",
      description: "text-gray-700 leading-relaxed",
      layout: "alternating" as const,
    },
    projTheme: {
      ...
      titleHover: "text-purple-600",
      description: "text-gray-600 leading-relaxed mb-4",
      badge: "bg-gradient-to-r from-purple-500 to-pink-500 text-white border-0 text-xs",
      cols: "grid grid-cols-1 md:grid-cols-3 gap-8",
    },
  },
  {
    ...
    expTheme: {
      line: "bg-yellow-500",
      nodeGradient: "from-yellow-500 to-orange-500",
      card: "bg-white/90 backdrop-blur-sm border-0 shadow-xl rounded-3xl hover:shadow-2xl transition-all",
      position: "text-gray-900",
      company: "text-orange-600 font-semibold",
      badge: "bg-gradient-to-r from-yellow-500 to-orange-500 text-white border-0",
      description: "text-gray-700 leading-relaxed",
      layout: "alternating" as const,
    },
    projTheme: {
      ...
      imageBg: "bg-gray-100",
      title: "text-xl font-bold text-gray-900",
      titleHover: "text-orange-600",
      description: "text-gray-600 leading-relaxed mb-4",
      badge: "bg-gradient-to-r from-yellow-500 to-orange-500 text-white border-0 text-xs",
      cols: "grid grid-cols-1 md:grid-cols-3 gap-8",
    },
  },
];
...
const SECTION_HEADER_BASE = {
  titleClass: "text-6xl font-black mb-4",
  ...
  useEffect(() => {
    if (isPlaying) {
      const interval = setInterval(
        () => setCurrentColorIndex((prev) => (prev + 1) % COLOR_THEMES.length),
        4000
      );
          ...
          <div className="relative min-h-screen overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
              {[...Array(6)].map((_, i) => (
                <motion.div
                  key={i}
                  animate={{ y: [0, -30, 0], x: [0, Math.sin(i) * 20, 0], rotate: [0, 360] }}
            ...
            <div className="relative z-10 px-8 py-16">
              <div className="max-w-7xl mx-auto">
                  ...
                  >
                    <div className="space-y-6">
                      ...
                      >
                        ...
                        <span className={`block bg-gradient-to-r ${currentTheme.primary} bg-clip-text text-transparent`}>VISIONARY</span>
                      </motion.h1>
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{ width: "200px" }}
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.2 }} className="flex gap-6">
                      <Button
                    ...
                    <div className="relative w-full max-w-lg mx-auto">
                      ...
                      >
                        <div className="text-center">
                          <div className="text-3xl font-bold text-orange-500">{portfolioData.projects?.length || 25}+</div>
                      ...
                      >
                        <div className="text-center">
                          <div className="text-3xl font-bold text-orange-500">{portfolioData.experience?.length || 8}+</div>
                ...
                >
                  <Button onClick={() => setIsPlaying(!isPlaying)} variant="outline" size="sm" className="rounded-full">
                  ...
                  <div className="flex gap-3">
                    {COLOR_THEMES.map((theme, index) => (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.9 }}
                        className={`w-8 h-8 rounded-full bg-gradient-to-r ${theme.primary} ${index === currentColorIndex ? "ring-4 ring-gray-400" : ""} transition-all duration-300`}
                      />
                    ))}
                  </div>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} className="space-y-8">
                  <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl rounded-3xl overflow-hidden">
                    <CardContent className="p-8">
                      ...
                      <p className="text-lg text-gray-700 leading-relaxed mb-6">{portfolioData.personalInfo.about}</p>
                  ...
                  <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl rounded-3xl">
                    <CardContent className="p-8">
                      ...
                      <div className="space-y-4">
                        {["Design with purpose and passion", "Every pixel tells a story", "Innovation through collaboration", "Beauty in simplicity"].map((philosophy, index) => (
                          ...
                          portfolioData.achievements.map((achievement, index) => (
                            <motion.div key={index} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }} className="flex items-start gap-4">
                              ...
                              <div>
                                ...
                                {formatDateRange(achievement.startDate, undefined, false).replace(/\s*-\s*$/, "")}
                              </span>
                              </div>
                            </motion.div>
                          ))
                    ...
                    <CardContent className="p-8">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        {["Photography", "Illustration", "Typography", "Motion Design", "Branding", "Art Direction"].map((interest, index) => (
                          <motion.div key={index} whileHover={{ scale: 1.05, y: -2 }} className={`bg-gradient-to-r ${currentTheme.primary} rounded-xl p-4 text-center text-white shadow-lg cursor-pointer`}>
            ...
            <div className="max-w-6xl mx-auto px-8">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                {[
                  ...
                  <motion.div key={index} initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.2 }} whileHover={{ y: -10 }}>
                          ...
                          {category.skills.slice(0, 6).map((skill, skillIndex) => (
                            ...
                            >
                              ...
                              <div className="flex gap-1">
                                {[...Array(5)].map((_, i) => (
                                  <Star key={i} className={`w-3 h-3 ${i < 4 ? "text-orange-400 fill-current" : "text-gray-300"}`} />
                                ))}
                              </div>
                            </motion.div>
                          ))}
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                      {portfolioData.skills && portfolioData.skills.length > 0 ? (
                        portfolioData.skills.map((skill, index) => (
                          <motion.div key={index} initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: index * 0.05 }} whileHover={{ scale: 1.1, y: -2 }}>
                            <Badge className={`bg-gradient-to-r ${COLOR_THEMES[index % COLOR_THEMES.length].primary} text-white border-0 px-4 py-2 text-sm`}>
                              {skill}
                            </Badge>
                          </motion.div>
                        ))
                ...
                <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} className="space-y-8">
                  <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl rounded-3xl">
                    <CardContent className="p-8">
                      ...
                      <div className="space-y-6">
                        {[
                          { icon: Mail, label: "Email", value: portfolioData.personalInfo.email, href: `mailto:${portfolioData.personalInfo.email}`, color: "from-red-500 to-pink-500" },
                          { icon: Phone, label: "Phone", value: portfolioData.personalInfo.phone, href: `tel:${portfolioData.personalInfo.phone}`, color: "from-green-500 to-emerald-500" },
                          { icon: MapPin, label: "Location", value: portfolioData.personalInfo.location, color: "from-blue-500 to-cyan-500" },
                        ]
                          ...
                          .map((item, index) => (
                            ...
                            >
                              ...
                              <div>
                                ...
                                <div className="text-gray-900 font-semibold group-hover:text-purple-600 transition-colors">{item.value}</div>
                              </div>
                ...
                <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} className="relative">
                  <Card className={`bg-gradient-to-br ${currentTheme.primary} text-white border-0 shadow-xl rounded-3xl overflow-hidden h-full`}>
                    <CardContent className="p-8 text-center h-full flex flex-col justify-center">
                      <motion.div animate={{ scale: [1, 1.1, 1] }} transition={{ duration: 2, repeat: Infinity }} className="w-24 h-24 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6">
                        <Heart className="w-12 h-12 text-white" />
                      </motion.div>
                      <h3 className="text-3xl font-bold mb-4">Ready to Create Something Amazing?</h3>
                      <p className="text-white/90 mb-8 leading-relaxed text-lg">
                        Let's collaborate and bring your creative vision to life. I'm passionate about creating beautiful, meaningful designs that make a real impact.
                      </p>
                      <div className="space-y-4">
              ...
              {NAV_ITEMS.map((item) => (
                <motion.button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-full transition-all duration-200 ${
                    activeSection === item.id ? `bg-gradient-to-r ${currentTheme.primary} text-white shadow-lg` : "text-gray-600 hover:text-gray-900 hover:bg-gray-100"
                  }`}
                >
